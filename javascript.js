...
const dashData = {
    ...
    music: {
        revenue: "$437,351", tickets: "11,968", avg: "$36.54", catPct: "50.0%", loyalty: "48%", retention: "3.5", leadTime: "49.6",
    ...
    family: {
        revenue: "$100,069", tickets: "4,551", avg: "$21.99", catPct: "19.4%", loyalty: "65%", retention: "7.5", leadTime: "48.5",
    ...
    rentals: {
        revenue: "$99,265", tickets: "4,369", avg: "$22.72", catPct: "18.0%", loyalty: "22%", retention: "1.1", leadTime: "17.7",
		...
		superFan: "Low Customer Loyalty."
    },
    dance: {
        revenue: "$56,703", tickets: "1,979", avg: "$28.65", catPct: "8.2%", loyalty: "55%", retention: "5.5", leadTime: "27.6",
    ...
    film: {
        revenue: "$15,881", tickets: "718", avg: "$22.12", catPct: "3.0%", loyalty: "74.8%", retention: "5.7", leadTime: "25.0",
		...
		superFan: "Highest Customer Loyalty!"
    }
};
    ...
    const updateUI = (cat) => {
		...
		document.getElementById('superFan').innerText = d.superFan;		
        ...
        if (cat === 'rentals') dzc.innerText = "Limited ROI 30 and 14-8 days before the event.";
        else if (cat === 'music') dzc.innerText = "Limited ROI 20-8 days before the event.";
        else if (cat === 'family') dzc.innerText = "Limited ROI 14-8 days before the event.";
        else dzc.innerText = "Limited ROI 14-8 days before the event.";
    ...
    const star = document.getElementById('starContainer');
    const trophy = document.getElementById('trophyContainer');
    const attention = document.getElementById('attantionContainer');
